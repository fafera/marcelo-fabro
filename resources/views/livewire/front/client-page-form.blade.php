            ...
            <div class="row">
                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 ">
                    <div class="form-group service-form-group">
                        ...
                        <input wire:model.lazy="name" id="name" name="name" type="text" placeholder="Nome completo"
                ...
                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 ">
                    <div class="form-group service-form-group">
                        ...
                        <input data-mask="000.000.000-00" wire:model.lazy="cpf" id="cpf" name="cpf" type="text" placeholder="CPF"
                            class="form-control" required>
                ...
                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                    <div class="form-group service-form-group">
                        ...
                        <input wire:model.lazy="street" id="street" name="street" type="text"
